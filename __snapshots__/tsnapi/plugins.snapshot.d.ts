 ...
 */
// #region Functions
export declare function DepsPlugin({ pkg, deps: { alwaysBundle: jsAlwaysBundle, onlyBundle, onlyImport, skipNodeModulesBundle, dts }, logger, nameLabel, platform }: ResolvedConfig, _: TsdownBundle): Plugin;
